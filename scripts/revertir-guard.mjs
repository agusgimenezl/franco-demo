...
const SRC = join(ROOT, 'workflows', 'franco-n8n-v27.json')
const REF = join(ROOT, 'workflows', 'franco-n8n-v26.json') // guard original, de referencia
const OUT = join(ROOT, 'workflows', 'franco-n8n-v28.json')
