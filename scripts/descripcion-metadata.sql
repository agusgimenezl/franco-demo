...
FROM (VALUES
  ...
  (6, 'Prácticamente sin uso y con motor turbo de 150 HP, la mayor potencia entre los autos no pickup del stock. Anda como un 0 km sin la espera ni el costo de patentamiento de una unidad nueva.', 'Es turbo: pide nafta de buena calidad y service al día para rendir como corresponde.', 'mediano'),
  (7, 'El que menos consume de todo el stock, gracias al 1.2 turbo, y con los kilómetros más bajos entre los autos. Rinde como un auto chico y anda como uno mediano.', 'Es caja manual: si buscás automático, el Vento es el equivalente del stock.', 'mediano'),
  ...
  (10, 'El auto más nuevo del stock fuera de las pickups y prácticamente sin uso. SUV automática con equipamiento completo: es la opción de quien quiere 0 km sin esperar.', 'El 1.6 aspirado prioriza suavidad antes que empuje: si buscás respuesta fuerte en ruta, el Vento turbo va mejor.', 'mediano'),
  (11, 'La SUV más barata del stock. Despeje alto y baúl grande, pensada para ripio y camino roto: es la que mejor aguanta el uso rudo por lo que cuesta.', 'La potencia es justa para el tamaño: si la vas a llevar cargada y en subida seguido, conviene una SUV de más motor.', 'mediano'),
  ...
  (16, 'Pickup casi sin uso, con la misma potencia que la unidad más cara del stock por bastante menos plata. Buena ecuación para trabajo liviano y ruta.', 'Es 4x2, no 4x4: para barro, ripio suelto o campo no reemplaza a una tracción integral.', 'grande'),
